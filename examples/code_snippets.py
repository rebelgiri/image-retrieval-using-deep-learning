...
def main():
    ...
    (ds_train_1, ds_test_1), ds_info_1 = tfds.load('fashion_mnist', data_dir='.',
    ...
    dataset = tf.data.Dataset.zip((ds_train_1, ds_train_1))

    dataset = dataset.cache()
    dataset = dataset.shuffle(ds_info_1.splits['train'].num_examples)
    ...
    ds_test_1 = ds_test_1.shuffle(ds_info_1.splits['test'].num_examples)
    ds_test_1 = ds_test_1.batch(100)
